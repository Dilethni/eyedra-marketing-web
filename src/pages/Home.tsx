  ...
  return (
    <div className="relative isolate">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            >
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Join EYEDRA, where technology meets emotional support. Connect with others, share experiences,
                and find the support you need in a safe, understanding community.
              </p>
      ...
      <div className="mx-auto mt-32 max-w-7xl sm:mt-40 sm:px-6 lg:px-8">
        <div className="relative isolate overflow-hidden bg-gradient-to-r from-primary-600 to-secondary-600 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <a
              href="#"
              className="rounded-full bg-white px-8 py-4 text-sm font-semibold text-primary-600 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
            >
              Download APK
            </a>
          </div>
